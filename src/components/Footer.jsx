        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/our-customers" className="hover:text-white">Our Clinics</a></li>
              <li><a href="/careers" className="hover:text-white">Awards & Certifications</a></li>
              <li><a href="/events" className="hover:text-white">Customer Reviews</a></li>
              <li><a href="/partners" className="hover:text-white">Official Blog</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/support" className="hover:text-white">Hearing Aid Guide</a></li>
              <li><a href="/contact" className="hover:text-white">Contact Us</a></li>
              <li><a href="/warranty" className="hover:text-white">Warranty & Repairs</a></li>
              <li><a href="/warranty" className="hover:text-white">Financing Options</a></li>
            </ul>
          </div>
        </div>
