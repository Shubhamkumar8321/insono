...
export default function Navigation() {
  ...
  const isFormPage = pathname === "/form"; // check if on form page
  ...
  return (
    ...
    >
      <div className=" w-full flex items-center justify-between px-2 sm:px-4 lg:px-28 py-2">
        {/* Logo */}
        ...
        {/* Only show full nav if NOT on /form page */}
        {!isFormPage && (
          <>
            {/* Desktop Nav */}
        ...
        <a
          ...
          className="flex items-center gap-2 bg-[#f59e0b] text-black font-medium px-4 py-2 rounded-md hover:bg-yellow-500 transition text-[18px] leading-[18px] "
        >
          <Phone size={16} />
          6204260510
        </a>
