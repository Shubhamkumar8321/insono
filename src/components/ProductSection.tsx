...
//           products: { nodes: any[] };
//         }>(GET_PRODUCTS);
//         // Map first category to product.category
//         const mappedProducts = data.products.nodes.map((product) => ({
//           ...product,
//           category: product.categories?.nodes?.[0]?.name || "Uncategorized",
//         }));
...
//   return (
//     <section className="py-12 max-w-7xl mx-auto px-6 md:px-20">
